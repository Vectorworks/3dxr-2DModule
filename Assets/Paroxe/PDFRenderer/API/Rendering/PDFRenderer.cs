...
namespace Paroxe.PdfRenderer {
    ...
    public sealed class PDFRenderer : IDisposable {
        ...
        byte[] RenderPageToByteArray(PDFPage page, int width, int height,
            ...
            float zoomFactor = 1f, float wFactor = 0f, float hFactor = 1f) {
            if (settings == null)
            ...
            float scale = (zoomFactor * width) / page.GetPageSize(1.0f).x;
            ...
            matrix.Scale(scale, -scale);
            matrix.Translate(wFactor * width, hFactor * height);
        ...
        /// <summary>
        /// Render page part into a new byte array. - kpresnakov
        /// </summary>
        /// <param name="page"></param>
        /// <param name="width"></param>
        /// <param name="height"></param>
        ...
        private
#endif
        byte[] RenderPagePartToByteArray(PDFPage page, int width, int height, Vector2 topLeftRelative, Vector2 bottomRightRelative, RenderSettings settings) {
            if (settings == null)
                settings = RenderSettings.defaultRenderSettings;
            ...
            matrix.Translate(-pageSize.x * scaleF * topLeftRelative.x , pageSize.y * scaleF * bottomRightRelative.y);
        ...
        private
#endif
        Texture2D RenderPageToTexture(PDFPage page, int width, int height, float zoomFactor = 1f, float wFactor = 0f, float hFactor = 1f) {
        ...
        Texture2D RenderPageToTexture(PDFPage page, int width, int height,
            ...
            RenderPageToExistingTexture(page, newTex, rectsProvider, settings, zoomFactor, wFactor, hFactor);

            return newTex;
        }

        /// <summary>
        /// Render page into a new Texture2D. - kpresnakov
        /// </summary>
        /// <param name="page"></param>
        /// <param name="width"></param>
        /// <param name="height"></param>
        ...
        private
#endif
        Texture2D RenderPagePartToTexture(PDFPage page, int width, int height, Vector2 topLeftRelative, Vector2 bottomRightRelative) {

            Texture2D newTex = new Texture2D(width, height, TextureFormat.RGBA32, false);

            RenderPagePartToExistingTexture(page, newTex, topLeftRelative, bottomRightRelative);
        ...
        void RenderPageToExistingTexture(PDFPage page, Texture2D texture,
            float zoomFactor = 1f, float wFactor = 0f, float hFactor = 1f) {
            RenderPageToExistingTexture(page, texture, null, RenderSettings.defaultRenderSettings, zoomFactor, wFactor, hFactor);
        }
        ...
        void RenderPageToExistingTexture(PDFPage page, Texture2D texture,
            IPDFColoredRectListProvider rectsProvider, RenderSettings settings,
            float zoomFactor = 1f, float wFactor = 0f, float hFactor = 1f) {
            byte[] byteArray = RenderPageToByteArray(page, texture.width, texture.height, rectsProvider, settings, zoomFactor, wFactor, hFactor);
        ...
        /// <summary>
        /// Render page part into an existing Texture2D. - kpresnakov
        /// </summary>
        /// <param name="page"></param>
        /// <param name="texture"></param>
        /// <param name="rectsProvider"></param>
        ...
        private
#endif
        void RenderPagePartToExistingTexture(PDFPage page, Texture2D texture, Vector2 topLeftRelative, Vector2 bottomRightRelative) {
            RenderPagePartToExistingTexture(page, texture, topLeftRelative, bottomRightRelative, RenderSettings.defaultRenderSettings);
        }
        ...
        private
#endif
        void RenderPagePartToExistingTexture(PDFPage page, Texture2D texture, Vector2 topLeftRelative, Vector2 bottomRightRelative, RenderSettings settings) {
            byte[] byteArray = RenderPagePartToByteArray(page, texture.width, texture.height, topLeftRelative, bottomRightRelative, settings);
